...
import { formatarCPF, formatarTelefone, removerFormatacao } from '../../util/utils';
...
const Paciente = () => {
    ...
    const renderizarData = (rowData: PacienteState) => moment(rowData.data_nascimento).format('DD/MM/YYYY');
    const renderizarTelefone = (rowData: PacienteState) => formatarTelefone(Number(rowData.telefone));

    const adicionarPaciente = async () => {
        await dispatch(pacienteTypesGetDataAction(initialPacienteState));
        setReadonly(false);
        setInclusao(true);
        setVisible(true);
    }

    const consultarPaciente = async (cpf: string) => {
        await dispatch(getPaciente(removerFormatacao(cpf, 11)));
        setReadonly(true);
        setInclusao(false);
        setVisible(true);
    }

    const alterarPaciente = async (cpf: string) => {
        await dispatch(getPaciente(removerFormatacao(cpf, 11)));
        setReadonly(false);
        setInclusao(false);
        setVisible(true);
                    ...
                    <div className="p-fluid">
                        <div className="p-field">
                            ...
                            <Calendar id="data_nascimento" disabled={readonly} required showIcon
                                value={moment(paciente.data_nascimento === "" ? new Date() : paciente.data_nascimento).toDate()}
                                onChange={(e) => dispatch(pacienteTypesChangeDataNascimentoAction(moment(e.target.value).format("YYYY-MM-DD")))}
                    ...
                    <div className="p-fluid">
                        <div className="p-field">
                            ...
                            <InputText id="logradouro" value={paciente.logradouro} disabled={true}
                                onChange={(e) => dispatch(pacienteTypesChangeLogradouroAction(e.target.value))} />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="p-fluid">
                        <div className="p-field">
                            ...
                            <InputText id="bairro" value={paciente.bairro} disabled={true}
                                onChange={(e) => dispatch(pacienteTypesChangeBairroAction(e.target.value))} />
                        </div>
                    </div>
                </div>
                <div className='col-5'>
                    <div className="p-fluid">
                        <div className="p-field">
                            ...
                            <InputText id="cidade" value={paciente.cidade} disabled={true}
                                onChange={(e) => dispatch(pacienteTypesChangeCidadeAction(e.target.value))} />
                        </div>
                    </div>
                </div>
                <div className='col-1'>
                    <div className="p-fluid">
                        <div className="p-field">
                            ...
                            <InputText id="estado" value={paciente.estado} disabled={true}
                                onChange={(e) => dispatch(pacienteTypesChangeEstadoAction(e.target.value))} />
                        </div>
                    </div>
                </div>
            </div>
